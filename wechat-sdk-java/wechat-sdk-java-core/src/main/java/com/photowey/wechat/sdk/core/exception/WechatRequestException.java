...
public class WechatRequestException extends RuntimeException {
    ...
    public WechatRequestException(String message, Object... args) {
        super(StringFormatter.format(message, args));
        this.message = StringFormatter.format(message, args);
    }

    public WechatRequestException(Throwable cause, String message, Object... args) {
