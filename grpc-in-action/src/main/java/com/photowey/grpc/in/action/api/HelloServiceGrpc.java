...
public final class HelloServiceGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<com.photowey.grpc.in.action.api.HelloProto.HelloRequest,
            com.photowey.grpc.in.action.api.HelloProto.HeResponse> getHelloMethod;

    @io.grpc.stub.annotations.RpcMethod(
            fullMethodName = SERVICE_NAME + '/' + "hello",
            requestType = com.photowey.grpc.in.action.api.HelloProto.HelloRequest.class,
            responseType = com.photowey.grpc.in.action.api.HelloProto.HeResponse.class,
            methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<com.photowey.grpc.in.action.api.HelloProto.HelloRequest,
            com.photowey.grpc.in.action.api.HelloProto.HeResponse> getHelloMethod() {
        io.grpc.MethodDescriptor<com.photowey.grpc.in.action.api.HelloProto.HelloRequest, com.photowey.grpc.in.action.api.HelloProto.HeResponse> getHelloMethod;
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
            synchronized (HelloServiceGrpc.class) {
                if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
                    HelloServiceGrpc.getHelloMethod = getHelloMethod =
                            io.grpc.MethodDescriptor.<com.photowey.grpc.in.action.api.HelloProto.HelloRequest, com.photowey.grpc.in.action.api.HelloProto.HeResponse>newBuilder()
                                    ...
                                    .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                            com.photowey.grpc.in.action.api.HelloProto.HeResponse.getDefaultInstance()))
    ...
    public interface AsyncService {
         ...
         *
         */
        default void hello(com.photowey.grpc.in.action.api.HelloProto.HelloRequest request,
                           io.grpc.stub.StreamObserver<com.photowey.grpc.in.action.api.HelloProto.HeResponse> responseObserver) {
    ...
    public static final class HelloServiceStub
         ...
         *
         */
        public void hello(com.photowey.grpc.in.action.api.HelloProto.HelloRequest request,
                          io.grpc.stub.StreamObserver<com.photowey.grpc.in.action.api.HelloProto.HeResponse> responseObserver) {
    ...
    public static final class HelloServiceBlockingStub
         ...
         *
         */
        public com.photowey.grpc.in.action.api.HelloProto.HeResponse hello(com.photowey.grpc.in.action.api.HelloProto.HelloRequest request) {
    ...
    public static final class HelloServiceFutureStub
         ...
         *
         */
        public com.google.common.util.concurrent.ListenableFuture<com.photowey.grpc.in.action.api.HelloProto.HeResponse> hello(
    ...
    private static final class MethodHandlers<Req, Resp> implements
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
                case METHODID_HELLO:
                    serviceImpl.hello((com.photowey.grpc.in.action.api.HelloProto.HelloRequest) request,
                            (io.grpc.stub.StreamObserver<com.photowey.grpc.in.action.api.HelloProto.HeResponse>) responseObserver);
                    break;
                default:
                ...
                .addMethod(
                        ...
                        io.grpc.stub.ServerCalls.asyncUnaryCall(
                                new MethodHandlers<
                                        ...
                                        com.photowey.grpc.in.action.api.HelloProto.HeResponse>(
