 ...
 */
@WebServiceClient(name = "HelloWebServiceImplService", targetNamespace = "http://server.webservice.service.action.in.webservice.photowey.com", wsdlLocation = "classpath:/wsdl/hello.wsdl")
public class HelloWebServiceImplService
    ...
    static {
        ...
        try {
            Resource wsdl = new ClassPathResource("wsdl/hello.wsdl");
            url = wsdl.getURL();
        } catch (Exception ex) {
