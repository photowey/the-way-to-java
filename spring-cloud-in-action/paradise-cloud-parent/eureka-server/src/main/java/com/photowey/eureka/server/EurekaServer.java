 ...
 */
package com.photowey.eureka.server;
...
public class EurekaServer {
    ...
    public static final Logger log = LoggerFactory.getLogger(EurekaServer.class);
    ...
    public static void main(String[] args) {
        ConfigurableApplicationContext applicationContext = SpringApplication.run(EurekaServer.class, args);
