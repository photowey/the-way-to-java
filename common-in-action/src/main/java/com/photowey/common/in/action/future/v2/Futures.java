...
public final class Futures {
     ...
     * @return T 类型
     */
    public static <T> T join(Future<T> future, long timeout, TimeUnit timeUnit) {
        return join(future, (x) -> {}, timeout, timeUnit);
    }
     ...
     * @return T 类型
     */
    public static <T> T join(Future<T> future, Consumer<Exception> fx, long timeout, TimeUnit timeUnit) {
        try {
