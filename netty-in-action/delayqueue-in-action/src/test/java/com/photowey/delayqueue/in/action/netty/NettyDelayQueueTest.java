 ...
 */
@Slf4j
class NettyDelayQueueTest {

    private NettyDelayQueue delayQueue;

    @BeforeEach
    void init() {
        this.delayQueue = new NettyDelayQueue();
    }
    ...
    void testDelayMillis() {
        ...
        log.info("-----------------------------------------start");
        this.delayQueue.delayMillis(listener, NettyDelayQueue.DEFAULT_TICK_DURATION * 5);
        log.info("-----------------------------------------submit");
    ...
    @Slf4j
    public static class OrderDelayListener extends AbstractNettyDelayedQueueListener<OrderData> {
