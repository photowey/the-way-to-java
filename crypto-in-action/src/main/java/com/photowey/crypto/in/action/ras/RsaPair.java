 ...
 * @since 1.0.0
 */
public class RsaPair implements Serializable {
    ...
    public RsaPair(PublicKey publicKey, PrivateKey privateKey) {
    ...
    public RsaPair setPublicKey(PublicKey publicKey) {
        this.publicKey = publicKey;
        return this;
    }
    ...
    public RsaPair setPrivateKey(PrivateKey privateKey) {
        this.privateKey = privateKey;
        return this;
    }
