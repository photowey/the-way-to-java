 ...
 * @since 2024/12/16
 */
public class LocalDateTimeStringDeserializer extends JsonDeserializer<LocalDateTime> implements LocalDateTimeTransformer {
    ...
    public LocalDateTime deserialize(JsonParser p, DeserializationContext deserializationContext) throws IOException {
        ...
        if (StringUtils.hasLength(datetime)) {
            ...
            // yyyy-MM-dd
            return LocalDateTime.parse(datetime, Datetime.shortFormatter());
        }
