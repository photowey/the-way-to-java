...
public class Knife4jConfigure {
    ...
    @Bean(value = "xxl-job-in-action-docket")
    public Docket appDocket() {
        String group = "xxl-job-in-action";
        ...
        Docket docket = new Docket(DocumentationType.OAS_30)
                ...
                .groupName(group)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.photowey.xxl.job.in.action.controller"))
    ...
    private ApiInfo populateApiInfo(Contact contact) {
        return new ApiInfoBuilder()
                .title("xxl-job-in-action project")
                .description("# xxl-job-in-action project RESTful APIs")
