...
public class AuthorizationServerConfigurer {
    ...
    private RegisteredClient createRegisteredClient(final String id) {
        return RegisteredClient
                ...
                .redirectUri("http://127.0.0.1:8082/login/oauth2/code/photowey-client-oidc")
                .redirectUri("http://127.0.0.1:8082/authorized")
                .redirectUri("http://127.0.0.1:8082/login/oauth2/code/photowey")
                .redirectUri("http://127.0.0.1:8082/hello/oidc")
