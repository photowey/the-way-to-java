 ...
 * @since 1.0.0
 */
public class AvgAggregation implements MethodAggregation<String, Object> {

    @Override
    public boolean support(AggregationType type) {
        return AggregationType.AVG.equals(type);
    }
    ...
    public String handle(Map.Entry<String, List<Object>> context, AggregationType type) {
        ...
        Long sum = candidates.stream()
                ...
                .reduce(0L, Long::sum);
        BigDecimal avg = new BigDecimal(String.valueOf(sum)).divide(new BigDecimal(String.valueOf(candidates.size())), 2, RoundingMode.HALF_UP);
