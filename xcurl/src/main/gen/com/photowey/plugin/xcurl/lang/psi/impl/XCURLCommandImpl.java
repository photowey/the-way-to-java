...
public class XCURLCommandImpl extends ASTWrapperPsiElement implements XCURLCommand {

  public XCURLCommandImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<XCURLOptions> getOptionsList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, XCURLOptions.class);
  }
