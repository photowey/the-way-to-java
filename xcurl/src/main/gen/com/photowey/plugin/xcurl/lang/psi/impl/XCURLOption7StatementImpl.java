...
public class XCURLOption7StatementImpl extends ASTWrapperPsiElement implements XCURLOption7Statement {

  public XCURLOption7StatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public XCURLOption7 getOption7() {
    return findNotNullChildByClass(XCURLOption7.class);
  }
