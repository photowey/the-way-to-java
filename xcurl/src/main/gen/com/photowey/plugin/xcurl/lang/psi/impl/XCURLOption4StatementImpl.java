...
public class XCURLOption4StatementImpl extends ASTWrapperPsiElement implements XCURLOption4Statement {

  public XCURLOption4StatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public XCURLOption4 getOption4() {
