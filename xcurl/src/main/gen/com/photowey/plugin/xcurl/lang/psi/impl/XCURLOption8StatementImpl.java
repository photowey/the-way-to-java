...
public class XCURLOption8StatementImpl extends ASTWrapperPsiElement implements XCURLOption8Statement {

  public XCURLOption8StatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public XCURLOption8 getOption8() {
    return findNotNullChildByClass(XCURLOption8.class);
  }
