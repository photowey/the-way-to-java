...
import com.photowey.plugin.xcurl.lang.psi.CURLOption8Statement;
...
public class CURLOption8StatementImpl extends ASTWrapperPsiElement implements CURLOption8Statement {

  public CURLOption8StatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CURLVisitor visitor) {
    visitor.visitOption8Statement(this);
  }
  ...
  @Override
  @NotNull
  public CURLOption8 getOption8() {
    return findNotNullChildByClass(CURLOption8.class);
  }
