...
import mybatis.mate.encrypt.RSA;
 ...
 * @author photowey
 * @date 2022/06/23
 * @see * https://gitee.com/baomidou/mybatis-mate-examples/blob/master/mybatis-mate-encrypt/src/test/java/mybatis/mate/encrypt/EncryptTest.java
 * @since 1.0.0
 */
@SpringBootTest
class UserMapperTest {

    // nested exception is mybatis.mate.O000000o.O000000o: please purchase activation code, thank you for your support!
    ...
    void testRSA() throws Exception {
        ...
        String Key = RSA.getPublicKey(keyMap);
        System.out.println("RSA 公钥：" + Key);
        ...
        String encodedData = RSA.encryptByPublicKey(source, Key);
        ...
        String target2 = RSA.decryptByPublicKey(encodedData2, Key);
        System.out.println("解密后: \r\n" + target2);
        System.err.println("私钥签名——公钥验证签名");
        String sign = RSA.sign(encodedData2.getBytes(), privateKey);
        System.err.println("签名:\r" + sign);
        boolean status = RSA.verify(encodedData2.getBytes(), Key, sign);
