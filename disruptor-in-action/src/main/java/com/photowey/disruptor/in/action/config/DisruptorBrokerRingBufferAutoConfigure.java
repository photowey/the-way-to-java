...
public class DisruptorBrokerRingBufferAutoConfigure {
    ...
    public RingBuffer<Event> ringBuffer(
            @Qualifier(EXECUTOR_SERVICE_BEAN_NAME) ExecutorService executor,
            @Qualifier(EVENT_FACTORY_BEAN_NAME) EventFactory factory,
        ...
        // @Deprecated
        Disruptor<Event> disruptor = new Disruptor<>(factory, BUFFER_SIZE, executor, ProducerType.SINGLE, waitStrategy);
