...
/**
 * {@code AccountNotActivatedException}.
 *
 * @author photowey
 * @version 1.0.0
 * @since 2025/02/14
 */
public class AccountNotActivatedException extends AuthcenterException {
    ...
    public AccountNotActivatedException(String message, Object... args) {
        this(
            ExceptionStatus.BAD_REQUEST.status(),
            ExceptionStatus.BAD_REQUEST.code(),
            message,
    ...
    public AccountNotActivatedException(int status, String message) {
        this(status, ExceptionStatus.resolve(status).code(), message);
    }

    public AccountNotActivatedException(int status, String message, Object... args) {
        this(status, ExceptionStatus.resolve(status).code(), message, args);
    }

    public AccountNotActivatedException(int status, String code, String message) {
        super(message);
        this.status = status;
        this.code = code;
    ...
    public AccountNotActivatedException(String code, String message, Object... args) {
        this(ExceptionStatus.INNER_ERROR.status(), code, message, args);
    }

    public AccountNotActivatedException(int status, String code, String message, Object... args) {
    ...
    public AccountNotActivatedException(ExceptionStatus exceptionStatus) {
        this(exceptionStatus.status(), exceptionStatus.code(), exceptionStatus.message());
    }

    public AccountNotActivatedException(
        ExceptionStatus exceptionStatus, String message, Object... args) {
        this(exceptionStatus.status(), exceptionStatus.code(), message, args);
    }

    public AccountNotActivatedException(ExceptionStatus exceptionStatus, Throwable cause) {
    ...
    public AccountNotActivatedException(String code, String message, Throwable cause) {
        super(message, cause);
        this.status = ExceptionStatus.INNER_ERROR.status();
        this.code = code;
        this.message = message;
    ...
    public static <T extends Throwable> boolean predicateIsSelf(T throwable) {
        return throwable instanceof AccountNotActivatedException;
    }
}
